...
class Reactome():
    ...
    def load_genes(self):
        ...
        ## yh kg
        # cancer_type = "breast";
        # pathway_genes = join(reactome_base_dir, "kg")
        # pathway_genes = join(pathway_genes, cancer_type)
        # filename = join(pathway_genes, "genes2pathways_2hop_v1.csv")
    ...
    def load_hierarchy(self):
        ...
        # pathway_genes = join(reactome_base_dir, "kg")
        # pathway_genes = join(pathway_genes, cancer_type)
        # filename = join(pathway_genes, "pathway2pathway_rels.csv")
        # df = pd.read_csv(filename, header=0)
